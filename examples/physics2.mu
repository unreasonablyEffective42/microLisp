...
(define main
  (lambda (s)
    (lets ((canvas (create-graphics-device width height))
           ...
           (balls (list 
             (make-ball 1.5   10 10 9 35 3 blue     'blue1_)
             (make-ball 1.5   10 14 9 35 3 blue     'blue2_)
             (make-ball 1.5   10 18 9 35 3 blue     'blue3_)
             (make-ball 1.5   10 22 9 35 3 blue     'blue4_)
             (make-ball 1.5   10 26 9 35 3 blue     'blue5_)
             (make-ball 1.5   10 30 9 35 3 blue     'blue6_)
             (make-ball 1.5   10 34 9 35 3 blue     'blue7_)
             (make-ball 1.5   10 38 9 35 3 blue     'blue8_)
             (make-ball 1.5   10 42 9 35 3 blue     'blue9_)
             (make-ball 1.5   10 46 9 35 3 blue     'blue10)

             (make-ball 1.5   90 11 -9 35 3 red      'red1_)
             (make-ball 1.5   90 15 -9 35 3 red      'red2_)
             (make-ball 1.5   90 19 -9 35 3 red      'red3_)
             (make-ball 1.5   90 23 -9 35 3 red      'red4_)
             (make-ball 1.5   90 27 -9 35 3 red      'red5_)
             (make-ball 1.5   90 31 -9 35 3 red      'red6_)
